...
\qquad
    \begin{array}{c}
	 ...
	 \end{array}
\]
This is a different basis from the more usual ones \cite{SPLAG}, which can be taken as the rows of a $12\times 24$ matrix whose left half is the $12\times 12$ identity matrix.
